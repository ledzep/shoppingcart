...
$ordersql = "SELECT * FROM orders WHERE id = " . $validid;
$ordres = mysql_query($ordersql);
...
$itmres = mysql_query($itemssql);
$itemnumrows = mysql_num_rows($itmres);
...
while($itemsrow = mysql_fetch_assoc($itmres)) {
